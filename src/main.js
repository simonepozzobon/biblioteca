...
Vue.prototype.$http = axios.create({baseURL: process.env.VUE_APP_API_BASE})

const router = new VueRouter({mode: 'history', dir: __dirname, routes: routes})
...
new Vue({
  router,
  data: function() {
    return {api_base: process.env.VUE_APP_API_BASE, base: process.env.VUE_APP_BASE, records: []}
  },
  methods: {
